 ...
 * @author asus
 */
public class cibercrimen extends Casos_1{

    String asociacion;

    public cibercrimen(String asociacion, int codigo, String tipo, String descrip, String priori, String nomclave, String fecha, String observacion) {
    ...
    public String getDataStringFormat() {
        return this.codigo +";"+ "Ciber Crimen" +";"+ this.descrip +";"+ this.priori+";"+this.nomclave+";"+this.fecha+";"+this.observacion+"\n";
        }
